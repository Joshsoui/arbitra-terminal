...
// ARBITRA targets the replacement Creators API. Keep auth/transport behind this
// adapter so marketplace logic does not depend on a deprecated Amazon contract.
